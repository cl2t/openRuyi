...
%define commit_id       e66ee54ceaad218e4aa2bfd7649f0eb67616ba07

Name:           go-github-basgys-goxml2json
Version:        1.1.1+git20260721.e66ee54
Release:        %autorelease
Summary:        XML to JSON converter written in Go (no schema, no structs)
License:        MIT
URL:            https://github.com/basgys/goxml2json
#!RemoteAsset:  sha256:10b603ea4bf07bb7802b31a9f6b41ed7e0851c69e7a9c7e8573f51ca28648ddf
Source0:        https://github.com/basgys/goxml2json/archive/%{commit_id}.tar.gz#/%{_name}-%{version}.tar.gz
BuildArch:      noarch
