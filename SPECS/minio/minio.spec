...
BuildRequires:  minio-console-frontend = 0+git20260909.2017f33
...
grep -Fx '# github.com/minio/console v1.7.7-0.20250905210349-2017f33b26e1' vendor/modules.txt
rm -rf vendor/github.com/minio/console/web-app/build
cp -a %{_datadir}/minio-console-frontend vendor/github.com/minio/console/web-app/build
...
# The frontend is embedded in the executable, so retain its dependency notices.
mkdir -p %{buildroot}%{_defaultlicensedir}/%{name}/console
cp -a %{_defaultlicensedir}/minio-console-frontend/. %{buildroot}%{_defaultlicensedir}/%{name}/console/
...
%doc README*
%license LICENSE*
%license %{_defaultlicensedir}/%{name}/console/
%{_bindir}/%{_name}
